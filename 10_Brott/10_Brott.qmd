...
```{r}
#| fig-height: 3
RIdifTable(df.f75, dif.gender)
```
#### Figur item 
```{r}

RIdifFigure(df.f75, dif.gender)
```
#### Figur svarströsklar
```{r}
RIdifFigThresh(df.f75, dif.gender)
```
:::
::::
...
```{r}
#| fig-height: 3
RIdifTable(df.f75, dif.arskurs)
```
#### Figur item 
```{r}

RIdifFigure(df.f75, dif.arskurs)
```
#### Figur svarströsklar
```{r}
RIdifFigThresh(df.f75, dif.arskurs)
```
:::
::::
