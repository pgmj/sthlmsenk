...
responsesF55<-read.csv("../../data/responsesF55.csv")
...
### Item fit
```{r}
RIitemfitPCM2(df.skolpos, 400, 32, 8)
```
### PCA
```{r}
#| tbl-cap: "PCA of Rasch model residuals"
