...
itemlabels.final <- read_excel("../../data/2023-02-02_allItemInfo.xls")
...
## NOTERA: denna fil är ej uppdaterad
...
RISE har tagit fram fem grundläggande kriterier och en rapporteringsmall för vetenskapliga psykometri-artiklar som har varit utgångspunkt för analysarbetet. Artikeln finns som preprint [@johansson].

En förenklad beskrivning (nedan) av psykometriska kriterier kommer från RISE rapport till MFoF om uppföljning av föräldraskapsstöd [@preuter2022]:
...
Två index, "Kamrater och fritid" samt "Prosocialt index", håller för dålig kvalitet för att kunna användas som indexvärde. Det kan eventuellt vara möjligt att skapa enklare nyckeltal utifrån items, som enbart återger nivåerna hög risk/låg risk.

För att vara konsekvent i detta skede har samtliga frågor och index "vänts" så att en högre poäng medför högre risk, trots att vissa index representerar skyddsfaktorer. Genomgående i samtliga index är frågorna bättre på att mäta högre nivåer av risk än lägre nivåer av risk.

Detta dokument sammanfattar resultatet av varje indexområdes analysprocess. Hela analysdokument för varje indexområde finns tillgängligt i menyn till vänster på denna sida, inklusive källkoden som visar hur analyserna gjorts, vilket möjliggör oberoende granskning givet tillgång till rådata.
...
Analys av delskalor finns sammanfattad, se @sec-ifDelskalorSmf
