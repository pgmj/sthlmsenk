...
df %>% 
  ...
  RIitemHierarchy()
```
Denna figur rangordnar items för att tydliggöra vilka frågor som, utifrån svarsdata, ger information om olika nivåer av indexvärdet. Items som ligger höger upp mäter högre nivåer av indexet bättre, och omvänt.
:::
